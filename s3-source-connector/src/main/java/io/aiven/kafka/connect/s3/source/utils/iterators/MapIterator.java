package io.aiven.kafka.connect.s3.source.utils.iterators;

/* this class lifted an modified from Apache Jena */
...
public class MapIterator<From, To> extends NiceIterator<To>
{
     ...
     */
    public MapIterator( Function<From, To> map, Iterator<From> base )
    {
        this.map = map;
        this.base = base;
    }
